/* Event click per al body, ha de buidar els cors i activar el hover.*/
window.addEventListener("load", function(e) {
    ...
    document.getElementsByTagName("body")[0].addEventListener("click", function(e) {
        ...
        for(i = 0; i < hearts.length; i++) {
            hearts[i].removeEventListener("click", conmutar, false);
...
function ponerHover() {
    ...
    for(i = 0; i < hearts.length; i++) {
        ...
        hearts[i].addEventListener("click", pinchar, false);
    }
}
...
function quitarHover() {
    ...
    for(i = 0; i < hearts.length; i++) {
        ...
        hearts[i].removeEventListener("click", pinchar, false);
        hearts[i].addEventListener("click", conmutar, false);
    }
}
